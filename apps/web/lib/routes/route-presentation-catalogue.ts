...
export const ROUTE_PRESENTATION_CATALOGUE = {
  ...
  "/trip/[tripId]/export": { scene: "utility", shell: "traveler", chrome: "task", footerMode: "none", texture: "none", fixture: { kind: "traveler-trip", suffix: "/export" }, states: ["unauthorized", "not-found", "empty", "loading", "pending", "saved", "error"] as const },
