...
const routes = {
  marketing: ["/", "/portugal", "/explore", "/explore/workspace", "/how-it-works", "/pricing", "/human-review", "/privacy", "/terms", "/sustainability", "/support", "/offline", "/sign-in", "/expert-chat", "/guide", "/b2b"],
  traveler: ["/planner", "/trip/new", "/checkout", "/itineraries", "/account", "/vault"],
