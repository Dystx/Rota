...
/**
 * Planner page — "AI Intent Engine"
 *
 * Source: docs/prototype.html (PlannerPage component, lines 210-230).
 * First port from the prototype to a Next.js App Router page.
 *
 * Visual identity: olive + ochre palette (Rumia v4 spec).
 * Stage 1 of the Tier 1 funnel: prompt-first itinerary generation.
 * CTA: synthesize -> /logistics.
 */
export default function PlannerPage() {
  return (
    <div className="bg-primary text-linen-dark antialiased min-h-screen flex flex-col relative overflow-x-hidden">
      <div
      ...
      <main className="flex-grow flex items-center justify-center px-container-padding-sm md:px-[48px] z-10 py-header-height">
