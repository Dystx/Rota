...
export function TopNav() {
  ...
  return (
    <nav
      aria-label="Primary"
      data-testid="top-nav"
      className="fixed top-0 w-full z-50 bg-linen-dark/95 backdrop-blur-md border-b border-olive-light/20 shadow-sm transition-all duration-300"
    >
      ...
      {mobileOpen ? (
        <div
          ...
          className="md:hidden border-t border-olive-light/20 bg-linen-dark/95 backdrop-blur-md"
        >
